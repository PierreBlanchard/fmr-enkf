...
%     <number>
%
% field = obs_correlation_function
%   - correlation function assoc to obs error covariance
%   values =
%     Gauss
%     Expo
%     None

% field = obs_correlation_length
%   - correlation length assoc to obs error covraiance
%   values =
%     <number>
%
% field = alpha
...
function [prm, fmt] = get_prmstruct(prm)
    ...
    if ~exist('prm', 'var')
        prm = struct(                       ...
            ...
            'obs_spacing',     {'regular'}, ...
            'obs_variance',    {0},         ...
            'obs_correlation_function',     {'None'}, ...
            'obs_correlation_length',    {0.},         ...
            'alpha',           {1},         ...
            'loc_len',         {NaN},       ...
            'loc_function',    {'Gauss'},   ...
            'loc_method',      {'CF'},      ...
    ...
    fmt = struct(                         ...
        ...
        'obs_spacing',     {'%s'},        ...
        'obs_variance',    {'%g'},        ...
        'obs_correlation_function',     {'%s'},        ...
        'obs_correlation_length',    {'%g'},        ...
        'alpha',           {'%g'},        ...
        'loc_len',         {'%g'},        ...
        'loc_function',    {'%s'},        ...
        'loc_method',      {'%s'},        ...
